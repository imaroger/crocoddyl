...
#ifndef CROCODDYL_CORE_ACTIONS_Human_Running_HPP_
#define CROCODDYL_CORE_ACTIONS_Human_Running_HPP_
...
class ActionRunningModelHuman : public ActionModelAbstract {
 public: 
...
struct ActionDataHumanRunning : public ActionDataAbstract {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  template <typename Model>
  explicit ActionDataHumanRunning(Model* const model) : ActionDataAbstract(model) {}
};
